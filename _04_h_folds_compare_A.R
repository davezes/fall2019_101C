...
if(xbool.savePlots) { png(file.path("~", "Desktop", "logisticExample_compare_kfolds.png"), width=2000, height=1000, pointsize=28) }
par(mfrow=c(1, 2))
...
t.test(xls.xcost.out.logistic[[1]], xls.xcost.out.logistic[[5]])

t.test(xls.xcost.out.knn[[1]], xls.xcost.out.knn[[5]])



t.test(xls.xcost.out.logistic[[5]], xls.xcost.out.knn[[5]])
